...
export class Migration1757413477545 implements MigrationInterface {
    name = 'Migration1757413477545'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" SERIAL NOT NULL, "code" character varying(255) NOT NULL, "link" character varying, "title" jsonb NOT NULL, "content" jsonb NOT NULL, "is_deleted" boolean NOT NULL DEFAULT false, "price" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "category_id" integer, "created_system_user_id" integer, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
