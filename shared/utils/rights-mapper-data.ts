...
export const rightsListData = [
  ...
  {
    code: rightsMapperData.transactionImportRead,
    title: {
      hy: 'Գործարք ներկրում, դիտել ցանկը',
      en: 'Transaction import read list'
    }
  },
  {
    code: rightsMapperData.transactionImportReadDetails,
    title: {
      hy: 'Գործարք ներկրում, դիտել գործարքի ամբողջական ինֆորմացիան',
      en: 'Transaction import read details'
    }
  },
  {
    code: rightsMapperData.transactionImportCreate,
    title: {
      hy: 'Գործարք ներկրում, ստեղծել նոր գործարք',
      en: 'Transaction import create'
    }
  },
  {
    code: rightsMapperData.transactionImportDelete,
    title: {
      hy: 'Գործարք ներկրում, ջնջել գործարքը',
      en: 'Transaction import delete'
    }
  },
  {
    code: rightsMapperData.transactionImportDeleteDetails,
    title: {
      hy: 'Գործարք ներկրում, ջնջել գործարքի որևէ ինֆո/տող',
      en: 'Transaction import delete some details'
    }
  },
  {
    code: rightsMapperData.transactionImportReadAll,
    title: {
      hy: 'Գործարք ներկրում, դիտել բոլորի կողմից ստեղծվածները',
      en: 'Transaction import view all items'
    }
  },
  {
    code: rightsMapperData.transactionExportRead,
    title: {
      hy: 'Գործարք արտահանում, դիտել ցանկը',
      en: 'Transaction export read list'
    }
  },
  {
    code: rightsMapperData.transactionExportReadDetails,
    title: {
      hy: 'Գործարք արտահանում, դիտել գործարքի ամբողջական ինֆորմացիան',
      en: 'Transaction export read details'
    }
  },
  {
    code: rightsMapperData.transactionExportCreate,
    title: {
      hy: 'Գործարք արտահանում, ստեղծել նոր գործարք',
      en: 'Transaction export create'
    }
  },
  {
    code: rightsMapperData.transactionExportDelete,
    title: {
      hy: 'Գործարք արտահանում, ջնջել գործարքը',
      en: 'Transaction export delete'
    }
  },
  {
    code: rightsMapperData.transactionExportDeleteDetails,
    title: {
      hy: 'Գործարք արտահանում, ջնջել գործարքի որևէ ինֆո/տող',
      en: 'Transaction export delete some details'
    }
  },
  {
    code: rightsMapperData.transactionExportReadAll,
    title: {
      hy: 'Գործարք արտահանում, դիտել բոլորի կողմից ստեղծվածները',
      en: 'Transaction export view all items'
    }
  },
  {
    code: rightsMapperData.reportsPage,
    title: {
